...
```{r}
knitr::include_url("https://github.com/mmedl94/lionfish/blob/main/man/figures/1d_tour_demo.gif")
knitr::include_graphics("https://github.com/mmedl94/lionfish/blob/main/man/figures/1d_tour_demo.gif")
```
