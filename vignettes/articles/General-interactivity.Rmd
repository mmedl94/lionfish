...
knitr::include_graphics("https://raw.githubusercontent.com/mmedl94/lionfish_figures/main/figures/feature_selection_demo.gif")
```
...
```{r out.width="100%", echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/mmedl94/lionfish_figures/main/figures/subset_selection_demo.gif")
```
...
```{r out.width="100%", echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/mmedl94/lionfish_figures/main/figures/reset_selection_demo.gif")
```
...
```{r out.width="100%", echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/mmedl94/lionfish_figures/main/figures/update_frames_demo.gif")
```
...
```{r out.width="100%", echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/mmedl94/lionfish_figures/main/figures/n_bins_demo.gif")
```
...
```{r out.width="100%", echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/mmedl94/lionfish_figures/main/figures/animate_frames_demo.gif")
```
...
```{r out.width="100%", echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/mmedl94/lionfish_figures/main/figures/blendout_threshold_demo.gif")
```
...
```{r out.width="100%", echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/mmedl94/lionfish_figures/main/figures/save_demo.gif")
```
...
```{r out.width="100%", echo=FALSE}
knitr::include_graphics("https://raw.githubusercontent.com/mmedl94/lionfish_figures/main/figures/initiate_tours_demo.gif")
```
