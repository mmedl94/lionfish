...
```{r initialize python backend,  eval = FALSE}
...
-   Projection manipulation: the projection can be manipulated via drag and drop
using the right mouse button. (Note for Mac users using trackpads: two fingers
have to be used to right-click).
